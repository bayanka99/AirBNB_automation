...
def print_details_highest_rating(items):
    max_rating = 0.0
    title = ""
    subtitle = ""
    room_description = ""
...
def print_details_lowest_price(page):
...
def test_case_1_airbnb_search_and_analyze_results(page):
    ...
    print_details_highest_rating(items)

    filter_lowest_price(page)


    page.click('xpath=/html/body/div[9]/div/div/section/div/div/div[2]/div/div[2]/footer/div/a')

    print_details_lowest_price(page)
