...
def test_case_2_airbnb_search_and_reserve(page):
        ...
        for item in items:
            item_url = item.query_selector("a").get_attribute('href') if item.query_selector("a") else "No URL"
            ...
            if rating_element:
                ...
                if "out of" in rating_text:
                    ...
                    if rating_value > max_rating:
                        ...
                        max_rating_url = item_url
                        max_rating_element = item


        max_rating_element.click()
        print(f"Clicked on the item with the highest rating: {max_rating_url}, Rating: {max_rating}")
